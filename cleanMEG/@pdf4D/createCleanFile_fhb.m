function cleanCoefs = createCleanFile_fhb(~, inFile, varargin)
% forces cleaning the heartbeat
...
if exist('tryCleanOP.mat','file')
    ...
    [doLineF, doXclean, doHB, figH, QRS] = tryClean_fhb(MEG, samplingRate, trig, XTR, xChannels,...
